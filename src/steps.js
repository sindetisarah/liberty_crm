	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					With the UI, form and layout components specially prepared for Facit, you can
					easily set the screens suitable for your project.
				</p>
				<p>
	...
	<div className='row'>
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					Since the "Subheader" is in the same file as the page content, you can easily
					use the relevant components here.
				</p>
			</div>
		</div>
		<div className='col-md-4'>
	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					You can use your forms in different ways such as <b>modal</b>, <b>canvas</b> and{' '}
					<b>wizard</b> according to your needs.
				</p>
			</div>
		</div>
		<TourNavigation />
	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					Some sample screens have been made with "Facit" and it can give you an idea for
					your project.
				</p>
				<p>
	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					<b>Click</b> on the title of a task on the board to see detailed information.
				</p>
			</div>
		</div>
		<TourNavigation />
	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<p>
					After using the above filtering, you can click on the item and view its detailed
					information.
				</p>
			</div>
		</div>
	...
	<div className='row'>
		...
		<div className='col-md-8 d-flex align-items-center'>
			<div>
				...
				<small>With accordion, you can expand the menu and browse the pages in it.</small>
			</div>
		</div>
		<TourNavigation />
	</div>
		...
		<div className='row'>
			...
			<div className='col-12 mt-3'>
				<div className='row'>
					...
					<div className='col'>
						<Button icon='Close' color='danger' isLink onClick={() => setIsOpen(false)}>
							Close
						</Button>
					</div>
					<div className='col-auto'>
